...
QuantMdUser::QuantMdUser(CThostFtdcMdApi *mdapi, QuantMdHandler* response){
    this->mdapi = mdapi;
...
// 登录结果响应
void QuantMdUser::OnRspUserLogin()
{
...
// 登出结果响应
void QuantMdUser::OnRspUserLogout()
{
    flagOnRspUserLogined = false;
}

void QuantMdUser::RegQuoteStk(const char *stks)
{
...
void QuantMdUser::handleRegQuoteStk(const char *stkStrings)
{
...
void* QuantMdUser::getCallback_RtnDepthMarketData() {
	return this->pCallback_RtnDepthMarketData;
}
void QuantMdUser::setCallback_RtnDepthMarketData(void *cb) {
